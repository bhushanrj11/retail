    ...
    <div class="card">
        ...
        <div class="content">
            <form id="sale_header" class="form-horizontal" method="post" action="<?php echo base_url('site/add_sell_order') ?>" enctype="multipart/form-data" >
                ...
                <input type="hidden" value="" name="company_info_id"></input>
                ...
                <div class="container-fluid show-on-selection">
                    ...
                    <div class="amounts-section">   
                        ...
                        <div class="row">
                            <div  class="col-md-1 pull-right" ><input type="text" class="final-number col-md-12" required name="sgst" value="0" id="sgst"> </div> <div class="col-md-2 bold text-right pull-right">SGST (9%) : </div>
                        </div>
                        <div class="row">
                            <div  class="col-md-1 pull-right" ><input type="text" class="final-number col-md-12" required name="cgst" value="0" id="cgst"> </div><div class="col-md-2 bold text-right pull-right">CGST (9%) : </div>
                        </div>
                        <hr/>
                        <div class="row">    
